...
export default function AdminOverview() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Analytics Overview</h1>
        <p className="text-gray-600">A quick glance at platform metrics.</p>
      </div>
      ...
      <div className="glass-panel p-8 rounded-3xl bg-white shadow-xl shadow-gray-100/50">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/dashboard/admin/invoices" className="text-sm font-semibold text-[#16A34A] hover:text-[#1FAF57] flex items-center gap-1">
